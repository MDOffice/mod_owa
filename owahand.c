...
static void htp_error(request_rec *r, char *head)
{
    if (head)
    {
        ...
        morq_write(r, "<html>\n", -1);
        morq_write(r, "<head>\n", -1);
        morq_write(r, "<meta charset='utf-8'>\n", -1);
        morq_write(r, "<meta http-equiv='X-UA-Compatible' content='IE=edge'>\n", -1);
        morq_write(r, "<meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=no'>\n", -1);
        morq_print_str(r, "<title>%s</title>\n", head);
        morq_write(r, "<style>", -1);
        morq_write(r, "*, ::after, ::before {box-sizing: border-box;}", -1);
        morq_write(r, "html {display: -ms-flexbox;display: flex;-ms-flex-direction: column;flex-direction: column;-ms-flex: 1;flex: 1;height: 100%;overflow: hidden;}", -1);
        morq_write(r, "body{margin: 0;font-family: 'Inter',system-ui,-apple-system,'Segoe UI',Roboto,'Helvetica Neue',Arial,'Noto Sans','Liberation Sans',sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol','Noto Color Emoji';font-size: 0.875rem;font-weight: 400;line-height: 1.5715;color: #234161;background-color: #fff;-webkit-text-size-adjust: 100%;-webkit-tap-highlight-color: transparent;}", -1);
        morq_write(r, "body {display: -ms-flexbox;display: flex;-ms-flex-direction: column;flex-direction: column;-ms-flex: 1;flex: 1;height: 100%;overflow: hidden;}", -1);
        morq_write(r, "a {text-decoration: none;}", -1);
        morq_write(r, ".h6, h6 {font-size: 1rem;margin-top: 0;margin-bottom: calc(1.25rem * .75);font-weight: 400;line-height: 1.5715;}", -1);
        morq_write(r, ".page-content {display: -ms-flexbox;display: flex;-ms-flex-positive: 1;flex-grow: 1;position: relative;overflow: hidden;}", -1);
        morq_write(r, ".content-wrapper {display: -ms-flexbox;display: flex;-ms-flex-direction: column;flex-direction: column;-ms-flex: 1;flex: 1;position: relative;min-width: 0;}", -1);
        morq_write(r, ".content-inner {display: -ms-flexbox;display: flex;-ms-flex-direction: column;flex-direction: column;height: 100%;position: relative;overflow-y: auto;-webkit-overflow-scrolling: touch;}", -1);
        morq_write(r, "@media (prefers-reduced-motion: no-preference).content-inner {scroll-behavior: smooth;}", -1);
        morq_write(r, ".content {padding: 1.25rem; 1.25rem;-ms-flex-positive: 1;flex-grow: 1;}", -1);
        morq_write(r, ".d-flex {display: -ms-flexbox!important;display: flex!important;}", -1);
        morq_write(r, ".justify-content-center {-ms-flex-pack: center!important;justify-content: center!important;}", -1);
        morq_write(r, ".align-items-center {-ms-flex-align: center!important;align-items: center!important;}", -1);
        morq_write(r, ".flex-fill {-ms-flex: 1 1 auto!important;flex: 1 1 auto!important;}", -1);
        morq_write(r, ".text-center {text-align: center!important;}", -1);
        morq_write(r, ".text-start {text-align: left!important;}", -1);
        morq_write(r, ".mb-4 {margin-bottom: 1.875rem!important;}", -1);
        morq_write(r, ".mb-3 {margin-bottom: 1.25rem!important;}", -1);
        morq_write(r, ".mt-3, .my-3 {margin-top: 1.25rem!important;}", -1);
        morq_write(r, ".lh-1 {line-height: 1!important;}", -1);
        morq_write(r, ".fw-semibold {font-weight: 600!important;}", -1);
        morq_write(r, ".display-3 {font-size: 4rem;}", -1);
        morq_write(r, "@media (min-width: 768px){.mx-md-auto {margin-right: auto!important;margin-left: auto!important;}}", -1);
        morq_write(r, "@media (min-width: 768px){.w-md-50 {width: 50%!important;}}", -1);
        morq_write(r, ".cursor-pointer {cursor: pointer;}", -1);
        morq_write(r, ".collapse:not(.show) {display: none;}", -1);
        morq_write(r, ".btn {display: -ms-inline-flexbox;display: inline-flex;-ms-flex-pack: center;justify-content: center;-ms-flex-align: center;align-items: center;}", -1);
        morq_write(r, ".btn {display: inline-block;padding: 0.5rem 0.875rem;font-size: 0.875rem;font-weight: 400;line-height: 1.5715;color: #fff;text-align: center;vertical-align: middle;cursor: pointer;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;border: 1px solid #309fd6;border-radius: 0.375rem;background-color: #309fd6;box-shadow: 0 0 0 0 transparent;transition: color 0.15s ease-in-out,background-color 0.15s ease-in-out,border-color 0.15s ease-in-out,box-shadow 0.15s ease-in-out;}", -1);
        morq_write(r, "</style>\n", -1);
        morq_write(r, "</head>\n", -1);
        morq_write(r, "<body>\n", -1);
        morq_write(r, "<div class='page-content'>\n", -1);
        morq_write(r, "<div class='content-wrapper'>\n", -1);
        morq_write(r, "<div class='content-inner'>\n", -1);
        morq_write(r, "<div class='content d-flex justify-content-center align-items-center'>\n", -1);
        morq_write(r, "<div class='flex-fill'>\n", -1);
        morq_write(r, "<div class='text-center mb-4'>\n", -1);
        morq_write(r, "<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='378px' height='233px' viewBox='0 0 378 233' version='1.1'>", -1);
    morq_write(r, "<title>Artwork</title>", -1);
    morq_write(r, "<g id='Service-pages' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'>", -1);
        morq_write(r, "<g id='Desktop---Service---Error' transform='translate(-536.000000, -237.000000)'>", -1);
            morq_write(r, "<g id='Artwork' transform='translate(536.000000, 237.000000)'>", -1);
                morq_write(r, "<path d='M309.6495,232.723 C286.1875,232.723 271.2305,215.241 248.9135,206.329 C234.8285,200.917 219.8975,198.325 204.9415,198.325 C185.3655,198.325 165.7465,202.768 147.9415,211.142 C127.8945,220.152 99.6205,228.342 73.2665,228.342 C41.5605,228.342 12.6355,216.481 4.1955,179.923 C-1.5815,155.079 6.9135,137.672 29.7275,128.397 C38.4605,124.995 47.5025,119.868 52.4355,111.118 C59.2425,99.434 51.1825,81.757 49.6655,69.242 C45.5455,33.496 65.5345,24.046 92.8985,24.046 C108.2485,24.046 125.9205,27.021 142.9565,29.995 C159.9935,32.969 176.3925,35.944 189.2035,35.943 C194.5135,35.943 199.2085,35.432 203.0745,34.198 L201.0155,34.34 C210.4805,31.588 215.3675,22.139 224.0545,18.039 C229.1005,15.865 233.7935,14.922 238.2165,14.922 C264.3305,14.922 281.0065,47.809 305.0225,54.558 C317.6475,57.9 329.2155,55.706 341.9785,61.141 C357.5765,67.785 365.6375,85.461 365.4195,103.002 C364.4235,119.197 351.4805,129.672 344.1265,143.496 C335.4005,157.415 338.5595,163.508 342.9585,177.928 C350.7025,201.236 346.7005,226.274 320.1805,231.596 C316.4675,232.372 312.9745,232.723 309.6495,232.723' id='Fill-4' fill='#f1f4f9'/>", -1);
                morq_write(r, "<path d='M188.8825,28.187 C185.3355,28.187 185.3355,22.687 188.8825,22.687 C192.4295,22.687 192.4295,28.187 188.8825,28.187' id='Fill-5' fill='#f1f4f9'/>", -1);
                morq_write(r, "<path d='M25.9455,112.75 C18.8515,112.75 18.8515,101.75 25.9455,101.75 C33.0385,101.75 33.0385,112.75 25.9455,112.75' id='Fill-6' fill='#f1f4f9'/>", -1);
                morq_write(r, "<path d='M356.6325,156.612 C349.5385,156.612 349.5385,145.612 356.6325,145.612 C363.7265,145.612 363.7265,156.612 356.6325,156.612' id='Fill-7' fill='#f1f4f9'/>", -1);
                morq_write(r, "<path d='
                morq_write(r, "<path d='M168.2725,118.979 L155.8275,106.533 C155.1835,105.889 154.1385,105.889 153.4945,106.533 C152.8495,107.178 152.8495,108.222 153.4945,108.867 L165.9395,121.312 C166.5835,121.956 167.6285,121.956 168.2725,121.312 C168.9175,120.668 168.9175,119.623 168.2725,118.979' id='Fill-47' fill='#325265'/>", -1);
                morq_write(r, "<path d='M222.0395,106.532 L209.5925,118.976 C208.9485,119.621 208.9485,120.666 209.5925,121.31 C210.2375,121.954 211.2815,121.954 211.9265,121.31 L224.3725,108.866 C225.0165,108.221 225.0165,107.177 224.3725,106.532 C223.7285,105.888 222.6835,105.888 222.0395,106.532' id='Fill-48' fill='#325265'/>", -1);
                morq_write(r, "<path d='M224.3725,118.979 L211.9285,106.533 C211.2835,105.889 210.2395,105.889 209.5945,106.533 C208.9505,107.178 208.9505,108.222 209.5945,108.867 L222.0395,121.312 C222.6835,121.956 223.7285,121.956 224.3725,121.312 C225.0165,120.668 225.0165,119.623 224.3725,118.979' id='Fill-49' fill='#325265'/>", -1);
                morq_write(r, "<path d='M217.6195,135.162 L217.6195,147.445 C217.6195,149.876 215.6495,151.845 213.2195,151.845 L210.8465,151.845 C208.4165,151.845 206.4465,149.876 206.4465,147.445 L206.4465,135.162' id='Fill-50' fill='#EA8FA2'/>", -1);
                morq_write(r, "<polyline id='Fill-51' fill='#E67A94' points='213.9625 135.803 212.0325 150.103 210.1035 135.803 213.9625 135.803'/>", -1);
                morq_write(r, "<path d='M151.6395,136.523 L226.2265,136.523 C226.9855,136.523 227.6015,135.908 227.6015,135.148 C227.6015,134.389 226.9855,133.773 226.2265,133.773 L151.6395,133.773 C150.8805,133.773 150.2645,134.389 150.2645,135.148 C150.2645,135.908 150.8805,136.523 151.6395,136.523' id='Fill-52' fill='#325265'/>", -1);
                morq_write(r, "<path d='M139.4335,133.329 C146.5275,133.329 146.5275,122.329 139.4335,122.329 C132.3395,122.329 132.3395,133.329 139.4335,133.329' id='Fill-53' fill='#F0B6BF'/>", -1);
                morq_write(r, "<path d='M238.4335,133.329 C245.5275,133.329 245.5275,122.329 238.4335,122.329 C231.3395,122.329 231.3395,133.329 238.4335,133.329' id='Fill-54' fill='#F0B6BF'/>", -1);
            morq_write(r, "</g>", -1);
        morq_write(r, "</g>", -1);
    morq_write(r, "</g>", -1);
morq_write(r, "<style xmlns='' id='autoconsent-prehide'/></svg>\n", -1);
        morq_write(r, "<div class='w-md-50 mx-md-auto'>\n", -1);
        morq_write(r, "<h6 class='mt-3 cursor-pointer' onClick='document.getElementById(&quot;collapse-text&quot;).classList.toggle(&quot;show&quot;)'>На жаль, сталася помилка. Внутрішня помилка сервера!</h6>\n", -1);
        morq_write(r, "<div class='collapse' id='collapse-text'>\n<div class='mt-3 text-start'>\n", -1);
        morq_print_str(r, "<h1>%s</h1>\n", head);
    }
    else
    {
        morq_write(r, "</div>\n</div>\n", -1);
        morq_write(r, "</div>\n", -1);
        morq_write(r, "</div>\n", -1);
        morq_write(r, "<div class='text-center'><a href='/' class='btn btn-primary'>На головну</a></div>\n", -1);
        morq_write(r, "</div>\n", -1);
        morq_write(r, "</div>\n", -1);
        morq_write(r, "</div>\n", -1);
        morq_write(r, "</div>\n", -1);
